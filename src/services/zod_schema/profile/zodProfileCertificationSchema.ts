...
export function profileCertificationSchema() {
    ...
    return z.object({
        ...
        document: z.string().min(2, msg.profile.certification.document),
    });
}

export type ProfileCertificationFormType = {
    date: string,
    document: string,
} & z.infer<ReturnType<typeof profileCertificationSchema>>;