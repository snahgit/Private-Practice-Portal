import { Box, Card, Text, Badge, Group, Divider, Button } from "@mantine/core";
import { IconReceipt, IconUser, IconStethoscope, IconCalendar, IconCurrencyDollar, IconDownload, IconEye } from "@tabler/icons-react";

export const PaymentsLogQuickView = (props: { dataPass: any }) => {
