...
import { WalletTransactionQuickView } from "../detail/WalletTransactionQuickView";


export const WalletTransactionList = (props: { dataPass: any }) => {
    ...
    <Fragment>
      <PageDrawer
        ...
        dataPass={{
          ...
          component: <WalletTransactionQuickView dataPass={{ billInfo }} />,
