...
import { StaffMemberEduDetail } from "./StaffMemberEduDetail";
import { StaffMemberExpDetail } from "./StaffMemberExpDetail";

export const StaffMemberDetail = () => {
  ...
  return (
    <Box>
      <Box>
        <Breadcrumb
          dataPass={{
            pageTitle: "Staff Member Detail",
            items: [
              { title: "Manage Staff", href: "#" },
              { title: "Staff Members List", href: "/manage-staff/staff-member" },
              { title: "Staff Member Detail", href: "#", isActive: true },
            ],
          }}
        />
      </Box>
      ...
      <PageDrawer
        ...
        dataPass={{
          ...
          component:
            drawerType == 1 ? (
              <StaffMemberEduDetail />
            ) : (
              <StaffMemberExpDetail />
            ),
