...
import { StaffMemberQuickView } from "../detail/StaffMemberQuickView";
import { PageModal } from "../../../../../common/PageModal";
import { StaffMemberPinForm } from "../form/StaffMemberPinForm";
...
export const StaffMemberList = (props: { dataPass: any }) => {
    ...
    <>
      ...
      <PageDrawer
        ...
        dataPass={{
          ...
          component: <StaffMemberQuickView dataPass={{ staffMemberInfo }} />,
                                  ...
                                  <Table.Td className="p-4">
                                    ...
                                    >
                                      ...
                                      <Menu.Dropdown className="border border-gray-200 dark:border-gray-700 shadow-lg dark:bg-gray-800">
                                        ...
                                        <Menu.Item leftSection={<IconReplace size={16} />}
                                          className="hover:bg-blue-50 dark:hover:bg-blue-900 transition-colors duration-200"
                                          onClick={() => handleModal(val)}
                                        >
                                          <Text size="sm" fw={500}>
