...
import { StaffMemberList } from "./sections/list/StaffMemberList";
  ...
  return (
    <Box>
      <Box>
        <Breadcrumb
          dataPass={{
            pageTitle: "Staff Member List",
            items: [
              { title: "Manage Staff", href: "#" },
              { title: "Staff Member List", href: "#", isActive: true },
            ],
          }}
        />
      </Box>
      <Box>
        <Card withBorder shadow="sm" className="rounded-xl bg-white/80 dark:bg-slate-900/60 backdrop-blur-xl border-t border-slate-200/60 dark:border-slate-700/60">
          ...
          <StaffMemberList dataPass={{ staffMemberList }} />
