...
import { PageDateInput, PageSelect, PageTextInput } from "../../../common/PageInput"
import { IconCalendar, IconEyeTable, IconInfoSquare, IconNumber, IconPlus } from "@tabler/icons-react"
...
export const ProfileInsuranceCoveredForm = (props: { dataPass: any }) => {
              ...
              <Card withBorder radius="md" className="border-blue-200">
                ...
                <Card.Section className="px-4 py-3">
                  <FormWrapper
                    ...
                    submitButtonText={insuranceCoveredData == null ? "Add Insurance" : "Update Insurance"}
                      ...
                      <Grid.Col span={{ base: 12 }}>
                        <FormField label="Select Insurance" required >
                          <PageSelect
                            ...
                            size="sm"
                            data={['Test Insurance One', 'Test Insurance Two', 'Test Insurance Thre', 'Test Insurance Four']}
                            leftSection={<IconInfoSquare size={16} />}
                            {...form.getInputProps('selectInsurance')} />
                        </FormField>
                      </Grid.Col>
                      <Grid.Col span={{ base: 12 }}>
