...
import { PatientSendReportForm } from "../../form/PatientSendReportForm";
...
export const PatientFacilityReportDetail = () => {
    ...
    <div className="bg-gray-50 min-h-screen">
      <PageModal
        ...
        dataPass={{
          ...
          component: <PatientSendReportForm dataPass={{ targetFile }} />,
