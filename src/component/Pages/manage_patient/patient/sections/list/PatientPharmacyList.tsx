...
import { PatientPharmacyDetail } from "../detail/patient_all_records/PatientPharmacyDetail";
...
export const PatientPharmacyList = () => {
    ...
    const handleDrawer = (data: { type: string; data: any }) => {
        const originalAddAction = () => {
            if (data.type == "activityLog") {
                ...
                setPassComponentByMatch(
                    <PatientPharmacyDetail dataPass={{ detailData: data.data }} />
                )
            }
