...
import { IconCalendar, IconClock, IconHeartbeat, IconEye, IconDots, IconActivity } from "@tabler/icons-react";
...
import { PatientTreatmentDetail } from "../detail/patient_all_records/PatientTreatmentDetail";
...
export const PatientTreatmentList = () => {
    ...
    const handleDrawer = (data: { type: string; data: any }) => {
        const originalAddAction = () => {
            if (data.type == "activityLog") {
                ...
                setPassComponentByMatch(
                    <PatientTreatmentDetail dataPass={{ detailData: data.data }} />
                )
            }
