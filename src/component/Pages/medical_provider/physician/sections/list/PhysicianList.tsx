...
import { IconDots, IconEdit, IconMail, IconEye, IconPhone, IconInfoCircle, IconDetails } from "@tabler/icons-react";
...
import { PhysicianQuicView } from "../detail/PhysicianQuicView";
...
const PhysicianList = (props: { dataPass: any }) => {
    ...
    <Card.Section className="p-4">
      <PageDrawer
        ...
        dataPass={{
          ...
          component: (
            <PhysicianQuicView dataPass={{ physicianData }} />
          ),
          title: "Medical Provider Quick Information",
        }}
      />
      {
        currentData.length > 0 ? (
                      ...
                      currentData.map((val: any, key: number) => {
                        return (
                          <Card
                            ...
                            shadow="md"
                            radius="lg"
                            className="hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1 mt-16"
                          >
                  ...
                  <div className="overflow-x-auto">
                    ...
                    >
                      <Table.Thead className="">
                        <Table.Tr>
                          <Table.Th className="text-center min-w-60 p-4">Physician Name</Table.Th>
                          <Table.Th className="text-center min-w-40 p-4">Physician Contact</Table.Th>
                          <Table.Th className="text-center min-w-20 p-4">Gender</Table.Th>
                          <Table.Th className="text-center min-w-20 p-4">Status</Table.Th>
                                ...
                                <Table.Td className="text-center p-4">
                                  ...
                                  >
                                    ...
                                    <Menu.Dropdown className="border border-gray-200 dark:border-gray-700 shadow-lg dark:bg-gray-800">
                                      ...
                                      >
                                        <Text size="sm" fw={500}>Quick View</Text>
                                      </Menu.Item>
                                      <Menu.Item
                                      ...
                                      <Menu.Item
                                        ...
                                        onClick={() => navigateUrl({ data: val, type: "detail", url: 'detail' })}
                                      >
                                        <Text size="sm" fw={500}>View Detail</Text>
                                      </Menu.Item>
                                    </Menu.Dropdown>
                                  </Menu>
                                </Table.Td>
          ...
          title: "No Physician Found",
          description: "There are currently no physicians to display. This could be because:",
          reasons: [
            "• No physicians have been created yet",
            "• All physicians may have been archived",
...
export default React.memo(PhysicianList);
