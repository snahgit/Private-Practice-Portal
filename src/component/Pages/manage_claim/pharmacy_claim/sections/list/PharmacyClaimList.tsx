...
import { PharmacyClaimQuickView } from "../detail/PharmacyClaimQuickView";
import { PharmacyClaimSendForm } from "../form/PharmacyClaimSendForm";
import { useSecurityCheck } from "../../../../../../context/SecurityCheckContext";


const inr = new Intl.NumberFormat("en-IN", { style: "currency", currency: "INR", maximumFractionDigits: 2 });

export const PharmacyClaimList = (props: { dataPass: any }) => {
    ...
    <Fragment>
      ...
      <PageDrawer
        ...
        dataPass={{
          ...
          component: <PharmacyClaimQuickView dataPass={{ claimInfo }} />,
