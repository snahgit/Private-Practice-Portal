...
export const MemberSendReportForm = (props: { dataPass: any }) => {
            ...
            <Grid.Col span={{ base: 12 }}>
              <Card withBorder radius="md" className="border-blue-200 dark:border-blue-700 bg-white dark:bg-gray-800">
                <Card.Section className="p-4 bg-gray-50 dark:bg-gray-700 border-b border-gray-200 dark:border-gray-600">
                  <Group>
                    <Image src={targetFile}></Image>
                  </Group>
                </Card.Section>
                <Card.Section className="p-4">
                  <Alert icon={<IconAlertCircle size={16} />} color="red" variant="light" className="mb-0 bg-red-50 dark:bg-red-900/20 border-red-200 dark:border-red-700" >
                    <Text size="sm" className="text-gray-900 dark:text-white">The file will go to patient email <b>testuse@gmail.com</b> with encryption.</Text>
                  </Alert>
                </Card.Section>
