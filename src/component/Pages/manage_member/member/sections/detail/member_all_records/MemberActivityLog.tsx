...
export const MemberActivityLog = (__props: { dataPass: any }) => {
    const activityLogs = [
        {
            id: 1,
    ...
    const getActivityIcon = (type: string) => {
        switch (type) {
            case "booking_accepted":
                return <IconCalendarCheck size={20} className="text-green-600" />;
            case "booking_pending":
                return <IconClock size={20} className="text-yellow-600" />;
            case "consultation_completed":
                return <IconStethoscope size={20} className="text-blue-600" />;
            case "booking_cancelled":
                return <IconX size={20} className="text-red-600" />;
            case "prescription_issued":
                return <IconNotes size={20} className="text-purple-600" />;
            case "test_results":
                return <IconUserCheck size={20} className="text-indigo-600" />;
            default:
                return <IconAlertCircle size={20} className="text-gray-600" />;
        }
    };
